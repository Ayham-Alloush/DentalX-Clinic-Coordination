<?php 
  ...
  $query = "SELECT lab_name, first_name, last_name, lab_type, full_address FROM lab_users" ;
  $stmt = mysqli_prepare($con, $query) ;
  mysqli_stmt_execute($stmt) ;
  mysqli_stmt_store_result($stmt);
  mysqli_stmt_bind_result($stmt, $lab_name, $first_name, $last_name, $lab_type, $full_address) ;
              ...
              <div class="col">
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary mb-1 w-100">عرض التفاصيل</a>
                  </div>
                </div>
              </div>
            ' ;
